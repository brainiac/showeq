    ...
    m_flash(false)
{
  ...
  m_mapIcons[tIconTypeSpawnUnknown]
    .setImage(QBrush(gray), QPen(QBrush(NoBrush), 1, SolidLine, cap, join), 
	      tIconStyleCircle, tIconSizeRegular,
	      true, false, false, false);
  ...
  m_mapIcons[tIconTypeSpawnPlayerTeamOtherDeity]
    .setHighlight(QBrush(NoBrush), QPen(QBrush(SolidPattern), 1, SolidLine, cap, join),
		  tIconStyleCircle, tIconSizeXLarge,
		  true, false, false, true);
  ...
  m_mapIcons[tIconTypeSpawnPlayerTeamOtherDeityPet]
    .setImage(QBrush(NoBrush), QPen(QBrush(SolidPattern), 1, SolidLine, cap, join),
	      tIconStyleCircle, tIconSizeXLarge,
	      true, true, false, true);
