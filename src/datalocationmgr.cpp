...
QFileInfo DataLocationMgr::findExistingFile(const QString& subdir, const QString& filename,
											bool caseSensitive, bool preferUser) const
{
...
QFileInfo DataLocationMgr::findWriteFile(const QString& subdir, const QString& filename,
										 bool caseSensitive, bool preferUser) const
{
	if (preferUser)
